...
import (
	...
	"github.com/Chandan-DK/kubernetes-custom-controller/pkg/generated/client/clientset/versioned/scheme"
...
func (c *MygroupV1alpha1Client) PodCreators(namespace string) PodCreatorInterface {
	return newPodCreators(c, namespace)
}
